                        ...
                        <TooltipProvider delayDuration={100}>
                            <Tooltip>
                                ...
                                justify-center items-center group" >
                                    <BsArrowUpRight className="text-white text-3xl group-hover:text-accent-DEFFAULT" />
                        ...
                        <TooltipProvider delayDuration={100}>
                            <Tooltip>
                                ...
                                justify-center items-center group" >
                                    ...
                                    <BsGithub className="text-white text-3xl group-hover:text-accent-DEFFAULT" />
                    ...
                    <div className="w-full xl:w-[50%]">
                        <Swiper 
                            ...
                            <WorkSliderBtns 
                             ...
                             btnStyles="bg-accent-DEFFAULT hover:bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
                             />
                        </Swiper>
                    </div>
